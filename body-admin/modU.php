                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            ?>
                                <center><h4 class="title">Modificando Usuario <?php echo $nombreU;?></h4></center>
                            </div>
                            <div class="content">

                                <form action="../body-php/controlador/modUser.php" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="user" value="<?php echo $nombreU; ?>" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
